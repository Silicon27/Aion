...
[![Linux CI](https://github.com/Silicon27/Aion/actions/workflows/linux.yml/badge.svg)](https://github.com/Silicon27/Aion/actions/workflows/linux.yml)
...
> [!WARNING]\
> Kaion is still in premature development stages, later updates would be posted here, once 0.0.1 drops, the pre-built download files would be available both on [my website](https://blutography.com), and in [releases](https://github.com/Silicon27/Aion/releases). If you wish to contribute, consider scanning through [the contributing guide](CONTRIBUTING.md). Thanks for checking out this repository and consider giving it a star ⭐!
